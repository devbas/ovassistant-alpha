...
def get_vehicle_candidates(lon, lat, user_datetime, user_id): 
  ...
  '''
  observations['vehicle_travel_distance'] = [transportgeo.great_circle_distance(row['prev_neighbor_coords'], row['next_neighbor_coords']) for index, row in observations.iterrows()]
  ...
  '''
  observations['user_vehicle_distance'] = [transportgeo.great_circle_distance([lon, lat], row['current_neighbor_coords']) for index, row in observations.iterrows()]
