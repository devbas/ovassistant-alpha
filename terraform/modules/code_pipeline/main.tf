resource "aws_s3_bucket" "source" {
  bucket        = "ovassistant-experiment-source"
  acl           = "private"
  force_destroy = true
}
...
resource "aws_codebuild_project" "ovassistant_build" {
  name          = "ovassistant-codebuild"
  build_timeout = "10"
...
resource "aws_codepipeline" "pipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration {
        ProjectName = "ovassistant-codebuild"
      }
    }
  }
